...
.. raw:: html
    ...
    .cia-triangle {
        ...
        * {
        ...
        .bottom-left {
            left: 0;
           background: linear-gradient(145.98deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 50%, var(--dhbw-dark-red) 50%, var(--dhbw-dark-red) 100%);
        }
        .bottom-right {
            right: 0;
            background: linear-gradient(213.98deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0) 50%, var(--dhbw-dark-red) 50%, var(--dhbw-dark-red) 100%);
        }
        .bottom-left,
        .bottom-right {
            width: 200px;
